...
public static class WinFormsUtil
{
    ...
    internal static DialogResult Error(params string[] lines)
    {
        ...
        return MessageBox.Show(msg, Strings.Get("WinFormsUtil_ErrorTitle", "Error"), MessageBoxButtons.OK, MessageBoxIcon.Error);
    }
    ...
    internal static DialogResult Alert(bool sound, params string[] lines)
    {
        ...
        string msg = string.Join(Environment.NewLine + Environment.NewLine, lines);
        return MessageBox.Show(msg, Strings.Get("WinFormsUtil_AlertTitle", "Alert"), MessageBoxButtons.OK, sound ? MessageBoxIcon.Information : MessageBoxIcon.None);
    }
    ...
    internal static DialogResult Prompt(MessageBoxButtons btn, params string[] lines)
    {
        System.Media.SystemSounds.Asterisk.Play();
        string msg = string.Join(Environment.NewLine + Environment.NewLine, lines);
        return MessageBox.Show(msg, Strings.Get("WinFormsUtil_PromptTitle", "Prompt"), btn, MessageBoxIcon.Question);
    }
    #endregion
